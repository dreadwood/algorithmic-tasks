...
Write your code in `src/typical-arrays-problems.js`.
...
Write your code in `src/reverse-int.js`.
...
Write your code in `src/human-readable-number.js`.
...
Write your code in `src/towel-sort.js`.
...
Write your code in `src/brackets.js`
...
Write your code in `src/morse-decoder.js`
...
Write your code in `src/expression-calculator.js`
...
3. Run `npm run test` in command line.
4. You will see the number of passing and failing tests. 100% of passing tests is equal to 100p in score  
